...
//   const html = `<p>Hi ${mailParam.name},\nYou have sucessfully registered on the greensol api-dev website\nJust a few more steps to confirm your mail address. This link expires in 6 hours.</p> <p> <a href=${process.env.BASE_URL + "user/verify/" + _id + "/" + uniqueString}></a> to proceed </p>`
